...
func DefaultLANConfig() *Config {
	...
	return &Config{
		...
		IndirectChecks:          5,                      // Use 3 nodes for the indirect ping
		RetransmitMult:          5,                      // Retransmit a message 4 * log(N+1) nodes
		...
		GossipToTheDeadTime:  45 * time.Second,       // Same as push/pull
